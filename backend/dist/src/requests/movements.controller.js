...
let MovementsController = class MovementsController {
    ...
    async confirmReceipt(id, req) {
        ...
        if (!userEmail) {
            throw new common_1.BadRequestException("x-user header is missing");
        }
    ...
    async approveStaff(id, body, req) {
        const userEmail = req.headers["x-user"];
        if (!userEmail) {
            throw new common_1.BadRequestException("x-user header is missing");
        }
    ...
    async preparePickup(id, body, req) {
        const userEmail = req.headers["x-user"];
        if (!userEmail) {
            throw new common_1.BadRequestException("x-user header is missing");
        }
...
], MovementsController.prototype, "exportPdf", null);
__decorate([
...
__decorate([
    (0, common_1.Patch)(":id/approve-staff"),
    __param(0, (0, common_1.Param)("id")),
    ...
    __metadata("design:returntype", Promise)
], MovementsController.prototype, "approveStaff", null);
__decorate([
    (0, common_1.Patch)(":id/approve-ops"),
    __param(0, (0, common_1.Param)("id")),
    __param(1, (0, common_1.Body)()),
    __param(2, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object, Object]),
    __metadata("design:returntype", Promise)
], MovementsController.prototype, "approveOps", null);
__decorate([
    (0, common_1.Patch)(":id/prepare-pickup"),
    __param(0, (0, common_1.Param)("id")),
    __param(1, (0, common_1.Body)()),
    __param(2, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object, Object]),
    __metadata("design:returntype", Promise)
], MovementsController.prototype, "preparePickup", null);
