...
exports.RequestsModule = RequestsModule = __decorate([
    (0, common_1.Module)({ providers: [requests_service_1.RequestsService], controllers: [requests_controller_1.RequestsController, movements_controller_1.MovementsController] })
], RequestsModule);
