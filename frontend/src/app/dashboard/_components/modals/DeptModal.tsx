        ...
        <div style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.15rem" }}>
            ...
            <p style={{ fontSize: "0.72rem", color: "#64748b", margin: 0 }}>
              Register a new organizational department grouping.
            </p>
          </div>
          <button
            onClick={onCancel}
        ...
        <form onSubmit={onSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem", padding: "1.5rem" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.85rem" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: "0.25rem" }}>
              <label style={{ fontSize: "0.72rem", fontWeight: 600, color: "#475569" }}>Department Name *</label>
              <input
                type="text"
                required
